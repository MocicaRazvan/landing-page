...
export default function HomeTitle() {
  const text: ReactElement = (
    <div className="prose max-w-none mx-auto my-8 px-4 py-6 text-foreground text-xl text-start">
      <ul className="text-xl md:text-4xl leading-relaxed list-disc pl-5 md:space-y-6 list-outside">
        ...
        <li className="text-lg md:text-xl">
          Have the unique opportunity to have access at the most advanced AI for
          chatting about your health and fitness and to have a live review of
          your trainings. We are the first platform to offer this service, and
          we are proud to be at the forefront of this technology. We are
          constantly working to improve our platform and to offer the best.
        </li>
      </ul>
    </div>
  );
